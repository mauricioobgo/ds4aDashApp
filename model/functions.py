...
#reading the models
area_harvested_model = pickle.load(open('./models/area_harvested_model.pickle', 'rb'))
production_model = pickle.load(open('./models/production_model.pickle', 'rb'))
yield_model = pickle.load(open('./models/yield_model.pickle', 'rb'))
